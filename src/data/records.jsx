...
export class Records extends React.Component {
    ...
    componentDidMount(){
        ...
        const dba = query(ref(db, 'TS_ByPatient'), orderByChild('patientEmail'),equalTo(userEmail));
                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        ...
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey">
                                <div class="font-bold text-xl">Your Records</div>
                            </div>
                            <div class="table-responsive">
                                <table class="table text-grey-darkest">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Preffered Timeslot</th>
                                        <th scope="col">Q1</th>
                                        <th scope="col">Q2</th>
                                        <th scope="col">Q3</th>
                                        <th scope="col">Q4</th>
